...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 py-2 bg-primary text-end top-fixed">
            <div class="dropdown">
    ...
    <div class="row mt-4">
    <div class="col-lg-2 position-fixed vh-100" style="padding-top: 5px;">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link <?php echo (isset($_GET['hal']) && $_GET['hal'] == 'keluhan' ? "active" : "") ?>" href="form_service.php">Keluhan Pengguna</a>
        </div>
    </div>
</div>
